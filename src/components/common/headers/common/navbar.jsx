                ...
                <div className="main-navbar">
                    <div id="mainnav" >
                        ...
                        <ul className="nav-menu" style={this.state.navClose}>
                            ...
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/shop-now`} className="nav-link" onClick={(e) => this.handleSubmenu(e)}>
                                    {translate('shop_now')}
                                    {/* <span className="sub-arrow"></span> */}
                                </Link>
                                {/* <ul className="nav-submenu">
                                    <li><Link to={`${process.env.PUBLIC_URL}/shop--now/collection`} >{translate('category_left_sidebar')}</Link></li>
                            ...
                            <li >
                                <Link to={`${process.env.PUBLIC_URL}/book-repair`} className="nav-link" onClick={(e) => this.handleSubmenu(e)}>
                                    {translate('book_repair')}
                                    {/* <span className="sub-arrow"></span> */}
                                </Link>
                            </li>
                            ...
                            {/* <li >
                                ...
                                <ul className="nav-submenu">
                                    <li><Link to={`${process.env.PUBLIC_URL}/shop--now/product/1`} >{translate('left_sidebar')}</Link></li>
                            ...
                            {/* <li >
                                <Link to="blog" className="nav-link" onClick={(e) => this.handleSubmenu(e)}>
                                    {translate('blog')}
                                </Link>                               
                            </li> */}
                        </ul>

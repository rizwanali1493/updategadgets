                                ...
                                <div className="col-lg-6">
                                    <div className="subscribe">
                                        <div>
                                            ...
                                            <p>Never Miss Anything From<b> Shop | Repair </b>By Signing Up To Our Newsletter. </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                        ...
                        <div className="row">
                            <div className="col-xl-6 col-md-6 col-sm-12">
                                <div className="footer-end">
                                    <p><i className="fa fa-copyright" aria-hidden="true"></i> My Site started by 2021
                                        Shop | Repair</p>
                                </div>
                            </div>
                            <div className="col-xl-6 col-md-6 col-sm-12">

                    ...
                    <div className="container">
                                ...
                                <table className="table cart-table table-responsive-xs">
                                    ...
                                    {Items.map((item, index) => {
                                        return (
                                            ...
                                            <tr>
                                                <td>
                                                    <Link to={`${process.env.PUBLIC_URL}/shop-now/product/${item.id}`}>
                                                        <img src={item.variants?
                                                                    item.variants[0].images
                                                                    :item.pictures[0]} alt="" />
                                                    </Link>
                                                </td>
                                                <td><Link to={`${process.env.PUBLIC_URL}/shop-now/product/${item.id}`}>{item.name}</Link>
                        ...
                        <div className="row wishlist-buttons">
                            <div className="col-12">
                                <Link to={`${process.env.PUBLIC_URL}/shop-now/collection`} className="btn btn-solid">continue shopping</Link>

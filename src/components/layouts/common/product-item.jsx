        ...
        return (
                <div className="product-box">
                    <div className="img-wrapper">
                        ...
                        <div className="front">
                            <Link to={`${process.env.PUBLIC_URL}/shop-now/product/${product.id}`} ><img
                                src={`${
                                    product.variants?
                    ...
                    <div className="product-detail">
                        <div>
                            ...
                            <Link to={`${process.env.PUBLIC_URL}/shop-now/product/${product.id}`}>
                                <h6>{product.name}</h6>
                            </Link>
                                        ...
                                        <div className="col-lg-6 rtl-text">
                                            <div className="product-right">
                                                ...
                                                <div className="product-buttons">
                                                    ...
                                                    <Link to={`${process.env.PUBLIC_URL}/shop-now/product/${product.id}`} className="btn btn-solid">view detail</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
